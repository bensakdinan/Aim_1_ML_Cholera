...
if __name__ == "__main__":
    ...
    relevant_columns = [
        ...
        'Duration_of_Dirrhoea_in_Hrs', 'Nature_of_Stool'
    ]
    ...
    X_encoded_metadata = pd.get_dummies(X, columns=['Area_Code', 'Nature_of_Stool'])
    X_encoded_metadata.to_csv("X_encoded.csv", index=False)
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_encoded_metadata, y, random_state=37, stratify=y)
    ...
    # To-Dos
    # Measure precision and recall for my model and also learn what that really means
